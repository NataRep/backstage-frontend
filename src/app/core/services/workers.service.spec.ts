...
describe('WorkerDataService', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [WorkerDataService, { provide: FirebaseService, useValue: spy }],
    });
  ...
  describe('getAllActive', () => {
    it('should return active workers', async () => {
      ...
      expect(firebaseSpy.query).toHaveBeenCalledWith('employees', jasmine.any(Array));
  ...
  describe('update', () => {
    it('should call firebase.update with correct parameters', async () => {
      ...
      expect(firebaseSpy.update).toHaveBeenCalledWith('employees', workerId, patch);
    });
  });
  describe('delete', () => {
    it('should call firebase.delete with correct parameters', async () => {
      ...
      expect(firebaseSpy.delete).toHaveBeenCalledWith('employees', workerId);
    });
  });
