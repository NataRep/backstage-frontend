...
export const createShowSuccessAction = createAction(
  '[Shows] Create Success',
  props<{ data: ShowItem }>()
);
export const createShowFailureAction = createAction(
  '[Shows] Create Failure',
  props<{ error: string }>()
);

// --- Update ---
export const updateShowAction = createAction('[Shows] Update', props<{ data: ShowItem }>());
export const updateShowSuccessAction = createAction(
  '[Shows] Update Success',
  props<{ data: ShowItem }>()
);
export const updateShowFailureAction = createAction(
...
export const deleteShowSuccessAction = createAction(
  '[Shows] Delete Success',
  props<{ id: string }>()
);
export const deleteShowFailureAction = createAction(
  '[Shows] Delete Failure',
  props<{ error: string }>()
);

// --- Read (One-time) ---
export const getAllShowAction = createAction('[Shows] Get All');
export const getAllShowSuccessAction = createAction(
  '[Shows] Get All Success',
  props<{ items: ShowItem[] }>()
);
export const getAllShowFailureAction = createAction(
  '[Shows] Get All Failure',
  props<{ error: string }>()
);
...
export const ShowStreamUpdatedAction = createAction(
  '[Shows] Stream Updated',
  props<{ items: ShowItem[] }>()
);
