...
import {
  ...
  passwordValidator,
} from './reset-password.validators';
...
export class ResetPasswordComponent implements OnInit {
  ...
  form = new FormGroup(
    {
      ...
      repeat: new FormControl('', [
        Validators.required,
        passwordsMatchValidator('password', 'repeat'),
      ]),
    },
    {
  ...
  private updatePasswordError() {
    const passwordControl = this.passwordControl as FormControl;
    const shouldShowError = passwordControl?.invalid && passwordControl.touched;
    ...
    if (shouldShowError && passwordControl.errors) {
      if (passwordControl.errors['required']) {
        ...
        passwordControl.errors['uppercaseRequired'] &&
        !passwordControl.errors['digitRequired']
      ) {
